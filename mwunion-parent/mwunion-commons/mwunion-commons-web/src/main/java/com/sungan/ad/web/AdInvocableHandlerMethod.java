...
import com.sungan.ad.web.chain.MethodChainManager;
import com.sungan.ad.web.chain.MethodInvoker;
 ...
 * @since 3.1
 */
public class AdInvocableHandlerMethod extends HandlerMethod {
	 ...
	 */
	public AdInvocableHandlerMethod(Object bean, Method method) {
		super(bean, method);
	}
	 ...
	 */
	public AdInvocableHandlerMethod(HandlerMethod handlerMethod) {
		super(handlerMethod);
	}
	 ...
	 */
	public AdInvocableHandlerMethod(
	...
	private MethodChainManager methodChainManager;
	
	public MethodChainManager getMethodChainManager() {
		return methodChainManager;
	}

	public void setMethodChainManager(MethodChainManager methodChainManager) {
		this.methodChainManager = methodChainManager;
	}
	...
	public final Object invokeForRequest(NativeWebRequest request,
		...
		final Object[] args = getMethodArgumentValues(request, mavContainer, providedArgs);
		...
		if(methodChainManager!=null){
			MethodInvoker invoker = new MethodInvoker() {
				@Override
				public Object invoke() throws Exception {
					Object invoke = AdInvocableHandlerMethod.this.invoke(args);
					return invoke;
				}
			};
			ChainBean chainBean = new ChainBean( getBridgedMethod(), args, getBean());
			returnValue = methodChainManager.invoke(invoker, request, chainBean );
		}else{
