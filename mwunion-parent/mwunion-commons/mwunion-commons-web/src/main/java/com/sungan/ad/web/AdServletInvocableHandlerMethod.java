 ...
 * @since 3.1
 */
public class AdServletInvocableHandlerMethod extends AdInvocableHandlerMethod {
	 ...
	 */
	public AdServletInvocableHandlerMethod(Object handler, Method method) {
	 ...
	 */
	public AdServletInvocableHandlerMethod(HandlerMethod handlerMethod) {
		super(handlerMethod);
		initResponseStatus();
	}
	 ...
	 */
	public AdServletInvocableHandlerMethod wrapConcurrentResult(final Object result) {
	 ...
	 */
	private class CallableHandlerMethod extends AdServletInvocableHandlerMethod {

		public CallableHandlerMethod(Callable<?> callable) {
			super(callable, ClassUtils.getMethod(callable.getClass(), "call"));
			this.setHandlerMethodReturnValueHandlers(AdServletInvocableHandlerMethod.this.returnValueHandlers);
		}

		@Override
		public <A extends Annotation> A getMethodAnnotation(Class<A> annotationType) {
			return AdServletInvocableHandlerMethod.this.getMethodAnnotation(annotationType);
		}
	}
